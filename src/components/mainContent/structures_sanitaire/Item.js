...
const HospitalItem = ({nom, adresse, id, email, description, owner, onDeleteClick, onEditClick, onSeeClick }) => {
    ...
    return (
        <div id={`structureSanitaire-${id}`} className="doctor-card has-shadow" style={{marginBottom: 20+'px'}} >
            <div className="doc-info-wrap text-left">
                ...
                <div className="doc-info">
                    ...
                    <h5>{adresse}</h5>
                    <div className="">
                        <span className="dot" style={{cursor: 'pointer', marginRight:15+'px'}} onClick={handleDeleteClick}>
                        ...
                        <span className="dot" style={{cursor: 'pointer', marginRight:15+'px'}} onClick={handleEditClick}>
                            <i className="far fa-edit fa-2x" style={{color:'#01579B'}}></i>
                        </span>
                        <span className="dot" style={{cursor: 'pointer', marginRight:15+'px'}} onClick={handleSeeClick}>
                            <i className="far fa-eye fa-2x" style={{color:'black'}}></i>
                        </span>
                    </div>
                </div>
            </div>
            <div className="hos-info-footer mt-5">
                <div className="row mt-5">
                    <div className="col-lg-6 mt-5" style={{borderRight: "2px solid black", color: 'lightseagreen'}}>
                    ...
                    <div className="col-lg-6 mt-5" style={{color: 'darkred'}}>
