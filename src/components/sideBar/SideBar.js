...
const SideBar = () => {
  ...
  return (
    <div className="page-sidebar fixedscroll">
      <div
        className="page-sidebar-wrapper ps-container ps-active-y"
      ...
      >
        <ul className="wraplist" style={{ height: "auto" }}>
          ...
          <li className="">
            <a href="javascript:;">
              ...
              <span className="title">Demande de consultations</span>
              <span className="arrow "></span>
            </a>
            ...
            <ul className="sub-menu" wfd-invisible="true">
              <li>
                <Link to={"/demande_consultations"}>
                  Liste des demandes de consultations
                </Link>
              </li>
              <li>
          ...
          <li className="">
            ...
            <ul className="sub-menu" wfd-invisible="true">
              <li>
                <Link to={"/consultations"}>Liste des consultations</Link>
              </li>
              <li>
          ...
          <li className="">
            ...
            <ul className="sub-menu" wfd-invisible="true">
              <li>
                <Link to={"/patients"}>Liste des patients</Link>
              </li>
              <li>
          ...
          <li className="">
            ...
            <ul className="sub-menu" wfd-invisible="true">
              <li>
                <a className="" href="hos-schedule.html">
                  Doctor Schedule
                </a>
              </li>
              <li>
                <a className="" href="hos-book-appointment.html">
                  Book Appointment
                </a>
              </li>
            </ul>
          ...
          <li className="">
            ...
            <ul className="sub-menu" wfd-invisible="true">
              <li>
                <a className="" href="hos-payment.html">
                  Payments
                </a>
              </li>
              <li>
                <a className="" href="hos-add-payment.html">
                  Add Payment
                </a>
              </li>
              <li>
                <a className="" href="hos-patient-invoice.html">
                  Patient Invoice
                </a>
              </li>
            </ul>
          ...
          <li className="">
            ...
            <ul className="sub-menu" wfd-invisible="true">
              <li>
                <a className="" href="hos-faq.html">
                  FAQ
                </a>
              </li>
              <li>
                <a className="" href="hos-support.html">
                  Help center
                </a>
              </li>
            </ul>
        ...
        <div
          ...
          style={{ top: 0 + "px", height: 516 + "px", right: 3 + "px" }}
        >
          <div
            className="ps-scrollbar-y"
            style={{ top: 0 + "px", height: 293 + "px" }}
          ></div>
        </div>
      </div>
    </div>
