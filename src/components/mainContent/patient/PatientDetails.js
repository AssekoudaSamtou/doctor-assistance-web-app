...
class PatientDetails extends React.Component {
    ...
    componentWillMount() {
        ...
        PatientDataService.get(7)
        .then(response => {
            console.log(response.data.results);
            this.setState({patient: response.data.results});
        }).catch(e => {
            console.log(e);
        });
    }
                            ...
                            <div className="row">
                                <div className="doctors-list patient relative">
                                    <div className="doctors-head relative text-center">
                                        ...
                                        <h3 className="header w-text relative bold">Name : Smith Wright</h3>
                                    ...
                                    <div className="col-xs-12 mb-30">
                                        ...
                                        <div className="reminder-icon">
                                            <img src="../data/hos-dash/clock.png" width="60" alt=""/>
                                        </div>
