                ...
                <div className="content-body p">
                  <div className="row">
                    <div className="doctors-list patient relative">
                      ...
                      <div className="col-xs-12 mb-30">
                        <div className="reminder-wrapper has-shadow2">
                          ...
                          <div className="reminder-content">
                            <h4 className="w-text bold">Alarme de rappel</h4>
                            <h5 className="g-text">
                              Se renseigner sur un médecin
                            </h5>
                          </div>
                        </div>
                        <Link
                      ...
                      <div
                        class="modal fade col-xs-12"
                        id="cmpltadminModal-7"
                        tabindex="-1"
                        role="dialog"
                        aria-hidden="true"
                      >
                        ...
                        <div className="col-xs-12">
                          <ul className="project-activity list-unstyled mb-0">
                            ...
                            <li className="activity-list success">
                              <div className="detail-info">
                                <div className="visit-doc">
                                  <small className="text-muted">Visite</small>
              ...
              <div className="row mt-15">
                  ...
                  <div className="r1_graph1 db_box db_box_large has-shadow2">
                    <div className="pat-info-wrapper">
                      <div className="pat-info text-left">
                        <h5 className="">Pression Artérielle</h5>
                        <h6>Normal</h6>
                      </div>
                ...
                <div className="col-md-6 col-xs-12">
                  <div className="r1_graph1 db_box db_box_large has-shadow2">
                    <div className="pat-info-wrapper">
                      <div className="pat-info text-left">
                        <h5 className="">Fréquence cardiaque</h5>
                        <h6 className="red-text">Autour de la normale</h6>
                      </div>
                      <div className="pat-val relative">
                        <h4 className="value red-text">
                          107 <span>Par min</span>
                        </h4>
                      </div>
                    </div>
                ...
                <div className="col-md-6 col-xs-12">
                  <div className="r1_graph1 db_box db_box_large has-shadow2">
                    <div className="pat-info-wrapper">
                      <div className="pat-info text-left">
                        <h5 className="">Cholesterolémie</h5>
                        <h6>Normale</h6>
                      </div>
                      <div className="pat-val relative">
